  ...
  const fetchProducts = async () => {
    try {
      ...
      const response = await axiosBackend.get(
        `/api/v1/product?category=${categoryConverted}&limit=${limit}&page=${currentPage}`
      );
...
export default CategorProducts;
